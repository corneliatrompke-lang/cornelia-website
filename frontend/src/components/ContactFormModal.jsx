...
export const ContactFormModal = () => {
  const { modalOpen, setModalOpen, selectedService, sendFrom } = useContactForm();
      ...
      {modalOpen && (
        ...
        >
          ...
          >
            ...
            <HeroContactForm onClose={() => setModalOpen(false)} preselectedService={selectedService} sendFrom={sendFrom} />
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
