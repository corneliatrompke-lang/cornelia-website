...
export const RetreatApplicationModal = () => {
  const { applicationModalOpen, closeApplicationForm } = useContactForm();
    ...
    <AnimatePresence>
      {applicationModalOpen && (
        <motion.div
          ...
          data-testid="application-modal-backdrop"
        >
          <motion.div
          ...
          >
            ...
            <RetreatApplicationForm onClose={closeApplicationForm} />
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
...
export default RetreatApplicationModal;
