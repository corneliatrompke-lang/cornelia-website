...
const ExecutiveCoaching = () => {
  ...
  return (
    <div>
      <section className="bg-charcoal min-h-[65vh] flex items-end pb-20 pt-36" data-testid="coaching-hero">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16 w-full">
          ...
          <ScrollReveal delay={0.15}>
            <h1
              ...
              style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(40px, 6vw, 74px)", fontWeight: 400 }}
            >
              {s.hero.headline}
            </h1>
          </ScrollReveal>
      ...
      <section className="bg-ivory ct-section" data-testid="coaching-description">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
            <div className="lg:col-span-5">
              <ScrollReveal>
                <p className="ct-overline text-sage mb-4">{s.description.overline}</p>
            ...
            <div className="lg:col-span-6 lg:col-start-7">
              {s.description.body.split("\n\n").map((para, i) => (
                <ScrollReveal key={i} delay={0.1 + i * 0.08}>
                  <p className="text-charcoal/65 mb-5 leading-relaxed" style={{ fontFamily: "Manrope, sans-serif", fontSize: "15px", fontWeight: 300 }}>
                    {para}
                  </p>
                </ScrollReveal>
              ))}
      ...
      <section className="bg-charcoal ct-section" data-testid="coaching-for-whom">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
            <div className="lg:col-span-5">
              <ScrollReveal>
      ...
      <section className="bg-stone ct-section" data-testid="coaching-format">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <ScrollReveal>
            <p className="ct-overline text-charcoal/40 mb-4">{s.format.overline}</p>
      ...
      <section className="bg-charcoal ct-section-sm text-center">
        <div className="max-w-[520px] mx-auto px-6">
          <ScrollReveal>
            ...
            <Link to="/contact" className="btn-secondary mt-8 inline-block" data-testid="coaching-apply-btn">
              {s.cta.button}
            </Link>
          </ScrollReveal>
        </div>
