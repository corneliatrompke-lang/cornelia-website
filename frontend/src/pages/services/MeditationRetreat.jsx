          ...
          <AnimatePresence>
            {showContactForm && (<>
              ...
              <motion.div key="mr-panel" initial={{ opacity: 0, x: "100%" }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: "100%" }}
                ...
                <HeroContactForm onClose={() => setShowContactForm(false)} preselectedService="executive-retreats" sendFrom="Executive Retreat — Hero Section" />
              </motion.div>
            </>)}
          </AnimatePresence>
        </div>
                ...
                <AnimatePresence mode="wait">
                  {!showFinalForm ? (
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <HeroContactForm onClose={() => setShowFinalForm(false)} noPadding preselectedService="executive-retreats" sendFrom="Executive Retreat — Final CTA Section" />
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
