...
const TeamFacilitation = () => {
  ...
  return (
    <div>
      <section className="bg-charcoal min-h-[65vh] flex items-end pb-20 pt-36" data-testid="facilitation-hero">
      ...
      <section className="bg-ivory ct-section" data-testid="facilitation-description">
      ...
      <section className="bg-charcoal ct-section" data-testid="facilitation-for-whom">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
            <div className="lg:col-span-5">
              <ScrollReveal>
      ...
      <section className="bg-stone ct-section" data-testid="facilitation-format">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <ScrollReveal>
      ...
      <section className="bg-charcoal ct-section-sm text-center">
        <div className="max-w-[520px] mx-auto px-6">
          <ScrollReveal>
            ...
            <Link to="/contact" className="btn-secondary mt-8 inline-block" data-testid="facilitation-cta-btn">
              {s.cta.button}
            </Link>
          </ScrollReveal>
        </div>
