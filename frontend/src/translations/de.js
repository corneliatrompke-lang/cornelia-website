const de = {
  ...
  services: {
    ...
    organizationalAdvisory: {
      ...
      dimensions: {
        ...
        items: [
          { number: "01", title: "Führung", subtitle: "Wie Führung wirklich funktioniert", body: "Führung ist der stärkste Hebel für organisationale Veränderung. Wer führt, wie sie führen und was sie vorleben – das schafft die Bedingungen für alles andere. Wir schauen auf Entscheidungsmuster und die Lücke zwischen dem, was gesagt wird, und dem, was tatsächlich gelebt wird. Wo beides auseinanderklafft, stockt Veränderung. Immer." },
          { number: "02", title: "HR-Prozesse", subtitle: "Die Arbeit dahinter", body: "Wie eine Organisation einstellt, entwickelt und anerkennt – das ist keine Administration. Das sind die Entscheidungen, die zeigen, was wirklich zählt. Performance-Prozesse, Talent-Frameworks, Anerkennungssysteme – sie zeigen, was die Organisation tatsächlich wertschätzt, ob gewollt oder nicht. Wir schauen, was Ihre aktuellen Prozesse wirklich bewirken, wo sie bremsen – und was sich konkret ändern muss." },
          { number: "03", title: "Kultur", subtitle: "Was die Organisation tatsächlich lebt", body: "Kultur ist kein Programm und keine Werte an der Wand. Sie entsteht durch das, was täglich gelebt wird – was gefördert wird, was Raum bekommt, wie Menschen miteinander arbeiten. Das zu verstehen ist der Ausgangspunkt für echte Veränderung. Wir schauen, wie Menschen die Arbeit in der Organisation wirklich erleben – und wo es Hebel für Veränderung gibt." },
        ],
      },
      process: {
        overline: "Der Prozess",
        ...
        phases: [
          ...
          { number: "04", title: "Nachhaltige Begleitung", subtitle: "Begleitung für dauerhafte Veränderung", description: "Veränderung passiert nicht in einem Workshop. Die Zusammenarbeit begleitet den gesamten Prozess – während Neues eingeführt, erprobt und angepasst wird. So dass es wirklich hält." },
        ],
      },
      forWhomDetailed: {
        overline: "Für wen",
  ...
  footer: {
    tagline: "Executive Coaching, Organisationsentwicklung, Facilitation und Retreats für Führungskräfte.",
