const de = {
  ...
  services: {
    executiveCoaching: {
      ...
      forWhom: { overline: "Für wen", headline: "Diese Arbeit ist für Sie, wenn...", items: [
        { title: "Standard-Coaching reicht nicht mehr", body: "Sie sind Senior Executive, Gründer:in oder Beiratsmitglied. Sie haben bereits an Ihrer persönlichen Entwicklung gearbeitet. Standard-Coaching erreicht nicht mehr die Ebene, auf der Ihre eigentlichen Grenzen liegen." },
        { title: "Das Muster liegt tiefer als Strategie", body: "Sie spüren, dass das, was Sie zurückhält, kein strategisches oder taktisches Problem ist — es ist strukturell. Das Muster wiederholt sich über verschiedene Kontexte und Rollen hinweg. Kein Framework hat es bisher erreicht." },
        { title: "Sie navigieren echte Komplexität", body: "Sie befinden sich inmitten von etwas Bedeutsamem — organisatorisch, beruflich oder persönlich — und brauchen eine Begleitung, die das volle Gewicht halten kann, ohne es zu minimieren oder zu vereinfachen." },
        { title: "Sie wollen aus Ganzheit führen", body: "Sie wollen aus einer echten Mitte heraus führen — nicht aus Performance, Angst oder Erschöpfung. Sie suchen mehr als Optimierung, und Sie wissen bereits, was das bedeutet." },
        { title: "Sie sind bereit, in die Tiefe zu gehen", body: "Sie verstehen, dass echte Veränderung Zeit und echtes Engagement braucht. Sie sind bereit, nachhaltige Aufmerksamkeit in etwas zu investieren, das Sie wirklich verändert — nicht nur, wie Sie sich präsentieren." },
      ]},
