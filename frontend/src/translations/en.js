const en = {
  ...
  home: {
    ...
    services: {
      ...
      items: [
        { number: "01", title: "Executive Coaching & Advisory", description: "A confidential container for deep individual work. Designed for executives ready to lead from wholeness rather than performance.", link: "/executive-coaching" },
        { number: "02", title: "Executive Retreats", description: "An immersive residential format that creates space for the questions that never surface in the pace of daily operations.", link: "/executive-retreats" },
        { number: "03", title: "Leadership Team Facilitation", description: "Deep process work with leadership teams navigating complexity, conflict, and the invisible dynamics shaping collective performance.", link: "/leadership-team-facilitation" },
        { number: "04", title: "Organizational Advisory for People & Culture Transformation", description: "Strategic advisory for organisations at inflection points — culture, structure, and leadership architecture through a nervous system lens.", link: "/organizational-advisory" },
      ],
  ...
  workWithMe: {
    ...
    services: [
      { number: "01", title: "Executive Coaching & Advisory", description: "A sustained confidential partnership for senior executives and founders ready to develop from the inside out.", link: "/executive-coaching", cta: "Learn More" },
      { number: "02", title: "Executive Retreats", description: "An immersive residential retreat format that creates space for the questions no operational calendar allows.", link: "/executive-retreats", cta: "Learn More" },
      { number: "03", title: "Leadership Team Facilitation", description: "Deep facilitation work with executive leadership teams navigating complexity and collective transformation.", link: "/leadership-team-facilitation", cta: "Learn More" },
      { number: "04", title: "Organizational Advisory for People & Culture Transformation", description: "Strategic advisory for organisations at critical inflection points — culture, structure, and leadership examined at depth.", link: "/organizational-advisory", cta: "Learn More" },
    ],
